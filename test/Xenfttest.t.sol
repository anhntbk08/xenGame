...
contract NFTRegistryTest is Test {
    ...
    function _testRegisterNFT(address _msgSender, uint _id) internal {
    ...
    function _testSendEthToContract(address sender, uint amount) internal {
    ...
    function testValue() public {
        ...
        uint balanceEnd = address(0x9B06aA2C42E0b382D58Fe792d2C055449c3Dc73c).balance;
